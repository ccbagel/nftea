        ...
        <Navbar />
            <div className="p-10 md:px-36 flex flex-col leading-8 md:leading-10 text-xl">
                ...
                <div className="m-4">
                    ...
                    <p className="my-7">I was thinking of using <a href="https://redux-toolkit.js.org/" className="text-blue-500">Redux Toolkit</a> to store token ids so users could save a particular NFT and fetch them later on. I could`ve also done this using a database but I felt like it`s not needed at this point in time. I might include one later down the road though. In the end I just went with React`s built in <code className="px-1 bg-blue-900">context </code>API because I read about how it doesn`t play well with Nextjs`s pre-rendering methods.</p>
